  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(244, 91, 75, 1);fontSize:28px;">社区团购小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='shangjia'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商铺名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangpumingcheng" class="input" type="text" placeholder="商铺名称">
			   </div>
			 </div> -->
			<el-form-item label="商铺名称" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangpumingcheng" autocomplete="off" placeholder="商铺名称" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商铺地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangpudizhi" class="input" type="text" placeholder="商铺地址">
			   </div>
			 </div> -->
			<el-form-item label="商铺地址" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangpudizhi" autocomplete="off" placeholder="商铺地址" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			...
			<el-form-item label="经营范围" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.jingyingfanwei" autocomplete="off" placeholder="经营范围" type="text" />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`huiyuan` == this.tableName && this.ruleForm.jifen&&(!this.$validate.isNumber(this.ruleForm.jifen))){
      ...
      if(`shangjia` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      ...
      if(`shangjia` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      if(`shangjia` == this.tableName && this.ruleForm.jifen&&(!this.$validate.isNumber(this.ruleForm.jifen))){
        this.$message.error(`积分应输入数字`);
        return
      }
