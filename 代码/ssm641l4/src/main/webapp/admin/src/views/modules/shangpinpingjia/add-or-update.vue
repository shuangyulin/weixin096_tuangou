<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评论标题" prop="pinglunbiaoti">
          <el-input v-model="ruleForm.pinglunbiaoti" 
              placeholder="评论标题" clearable  :readonly="ro.pinglunbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评论标题" prop="pinglunbiaoti">
              <el-input v-model="ruleForm.pinglunbiaoti" 
                placeholder="评论标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商品评价" prop="shangpinpingjia">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shangpinpingjia" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinpingjia" label="商品评价" prop="shangpinpingjia">
                    <span v-html="ruleForm.shangpinpingjia"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商家回复" prop="shangjiahuifu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shangjiahuifu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangjiahuifu" label="商家回复" prop="shangjiahuifu">
                    <span v-html="ruleForm.shangjiahuifu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='pinglunbiaoti'){
            this.ruleForm.pinglunbiaoti = obj[o];
	    this.ro.pinglunbiaoti = true;
            continue;
          }
	    ...
	    this.ro.huiyuanxingming = true;
          ...
          if(o=='shangpinpingjia'){
            this.ruleForm.shangpinpingjia = obj[o];
	    this.ro.shangpinpingjia = true;
            continue;
          }
          if(o=='shangpintupian'){
	    ...
	    this.ro.shangpintupian = true;
          ...
          if(o=='shangjiahuifu'){
            this.ruleForm.shangjiahuifu = obj[o];
	    this.ro.shangjiahuifu = true;
            continue;
          }
          if(o=='userid'){
	...
	this.ruleForm.shangpinpingjia = this.ruleForm.shangpinpingjia.replace(reg,'../../../ssm641l4/upload');
	this.ruleForm.shangjiahuifu = this.ruleForm.shangjiahuifu.replace(reg,'../../../ssm641l4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shangpinpingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangpinpingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
