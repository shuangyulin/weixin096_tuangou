  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="姓名" prop="xingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="商铺名称" prop="shangpumingcheng">
          <el-input v-model="ruleForm.shangpumingcheng"               placeholder="商铺名称" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='shangjia'" label="商铺图片" prop="shangputupian">
          <file-upload
          tip="点击上传商铺图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.shangputupian?ruleForm.shangputupian:''"
          @change="shangjiashangputupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="商铺地址" prop="shangpudizhi">
          <el-input v-model="ruleForm.shangpudizhi"               placeholder="商铺地址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="积分" prop="jifen">
          <el-input v-model="ruleForm.jifen"               placeholder="积分" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'shangjia' ==this.flag && this.ruleForm.jifen&&(!isNumber(this.ruleForm.jifen))){
        this.$message.error(`积分应输入数字`);
        return
      }
