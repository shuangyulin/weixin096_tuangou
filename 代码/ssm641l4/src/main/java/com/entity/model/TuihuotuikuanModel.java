 ...
 */
public class TuihuotuikuanModel  implements Serializable {
	...
	public void setTuihuoliyou(String tuihuoliyou) {
		this.tuihuoliyou = tuihuoliyou;
	}
	
	/**
	 * 获取：退货理由
	 */
	public String getTuihuoliyou() {
		return tuihuoliyou;
	}
