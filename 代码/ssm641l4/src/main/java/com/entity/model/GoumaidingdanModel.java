...
public class GoumaidingdanModel  implements Serializable {
	...
	private String shangpinxianjia;
	...
	public void setShangpinxianjia(String shangpinxianjia) {
	 ...
	 * 获取：商品现价
	 */
	public String getShangpinxianjia() {
	...
	public void setZiqushijian(Date ziqushijian) {
		this.ziqushijian = ziqushijian;
	}
	
	/**
	 * 获取：自取时间
	 */
	public Date getZiqushijian() {
		return ziqushijian;
	}
